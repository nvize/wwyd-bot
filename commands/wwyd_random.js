...
module.exports = {
    ...
    execute: async function (message) {
        ...
        pythonProcess.on('close', async function (code) {
            ...
            let problemReply = await message.reply({ content: `${filePath}. Round: ${round}. Turn: ${turn}.` + 
            ...
            problemReply.edit({ content: `${filePath}. Round: ${round}. Turn: ${turn}. Puzzle name: ${game2.name}.` +
